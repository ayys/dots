...
function pick_random_file(directory)
    local command = "find '" .. directory .. "' -type f | shuf -n 1"
...
-- Wallpaper
    if beautiful.wallpaper then
        local wallpaper_dir = os.getenv("HOME") .. "/git/dots/wallpapers"
        local wallpaper = pick_random_file(wallpaper_dir)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "w",      function() screen.emit_signal("request:wallpaper") end,
